...
parser.add_argument("-d", "--design-name",    required=True,  help="Name of the top module in the design")
parser.add_argument("-i", "--input-def",      required=True,  help="Path to def file of the implemented design after detailed routing step")
parser.add_argument("-t", "--tech-file",      required=True,  help="Path to KLayout technology file, a mapping from LEF/DEF to GDS.")
...
parser.add_argument("-s", "--seal",           required=False, help="Path to seal seal GDS/OAS file", default="")
parser.add_argument("-l", "--layer-map",      required=False, help="Path to layer map file", default="")
...
for fil in args.additional_gds:
  print("\t{0}".format(fil))
